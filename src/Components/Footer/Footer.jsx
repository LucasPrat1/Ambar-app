      ...
      <div className={styles.containerSpans}>
        <span className={styles.social}>
          ...
          <div className={styles.socialIcons}>
            <a href="https://www.instagram.com/aroma.ambar" target="_blank" rel="noopener noreferrer"><i className="fa-brands fa-instagram fa-2xl"></i></a>
            <a href="http://www.instagram.com/aroma.ambar" target="_blank" rel="noopener noreferrer"><i className="fa-brands fa-facebook fa-2xl"></i></a>
            <a href="http://www.instagram.com/aroma.ambar" target="_blank" rel="noopener noreferrer"><i className="fa-brands fa-twitter fa-2xl"></i></a>
          </div>
        </span>
